...
type UseProducersInputsReturn = Awaited<ReturnType<typeof getProducersInputs>> | undefined;

export function useProducersInputs({ inventoryId }: UseProducersInputsParams): UseProducersInputsReturn
{
