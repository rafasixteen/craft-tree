	...
	return (
		<AppSidebar {...props}>
			...
			<NavGroup
				label="Inventory"
				items={[
					{ label: 'Items', href: `${base}/items`, icon: PackageIcon },
					{ label: 'Producers', href: `${base}/producers`, icon: FactoryIcon },
					{ label: 'Tags', href: `${base}/tags`, icon: TagsIcon },
					{ label: 'Production Graphs', href: `${base}/production-graphs`, icon: WaypointsIcon },
				]}
			/>
		</AppSidebar>
	);
