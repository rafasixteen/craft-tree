...
{
	return <ol data-slot="breadcrumb-list" className={cn('text-muted-foreground gap-1.5 text-xs/relaxed flex flex-wrap items-center break-words', className)} {...props} />;
}
