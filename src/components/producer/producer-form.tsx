...
const pairSchema = z.object({
	...
	quantity: z
		...
		.max(2_147_483_647, 'Quantity must be at most 2,147,483,647.'),
});
...
export const producerFormSchema = z.object({
	...
	time: z
		...
		.max(86400, 'Time must be at most 86400 seconds.'),
					...
					<Controller
						...
						render={({ fieldState }) => (
							<ItemPairsFieldArray
								name="inputs"
								form={form}
								description="Items required to produce outputs."
					...
					<Controller
						...
						render={({ fieldState }) => (
							<ItemPairsFieldArray
								name="outputs"
								form={form}
								description="Items produced by this producer."
								data-invalid={fieldState.invalid}
							/>
						)}
					/>
